PlayerEvents.loggedIn(event => {
  ...
  server.runCommandSilent(`effect give @a minecraft:slowness 2 5 true`)
  server.runCommandSilent(`effect give @a minecraft:slowness 4 2 true`)
  server.runCommandSilent(`effect give @a minecraft:slowness 6 1 true`)
  server.runCommandSilent(`effect give @a minecraft:slowness 10 0 true`)
  server.runCommandSilent(`effect give @a minecraft:weakness 10 0 true`)
