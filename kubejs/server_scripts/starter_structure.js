PlayerEvents.loggedIn(event => {
  ...
  server.runCommandSilent(`effect give @a minecraft:blindness 4 0 true`)
  server.runCommandSilent(`playsound clanginghowl:electric_shock player @a ${x + 34} ${y - 56} ${z + 22} 1.5 2`)
...
PlayerEvents.respawned(event => {
  ...
  server.runCommandSilent(`effect give @a minecraft:nausea 1 0 true`)
  server.runCommandSilent(`effect give @a minecraft:blindness 1 0 true`)
  server.runCommandSilent(`playsound block.sand.place block @a ${x} ${y} ${z} 0.8 1`)
  server.runCommandSilent(`particle minecraft:campfire_cosy_smoke ${x} ${y} ${z} 0.3 0.1 0.3 0 10`)
