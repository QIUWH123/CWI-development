...
// Natural Block
    ...
    event.create('small_scrap_block', 'cardinal')
        ...
        .box(8, 8, 0, 16, 12, 8, true)
        .box(8, 8, 8, 16, 10, 16, true)
        .notSolid()
        .redstoneConductor(false)
        .defaultCutout()
...
// Industrial Blocks
    ...
    event.create('forming_fabric')
        .soundType('wood')
        .hardness(1)
        .resistance(1)
        .mapColor('#FF5500')
        .box(1, 1, 1, 16, 2, 16, true)
        .tagBlock('minecraft:mineable/axe')
        .notSolid()
        .suffocating(false)
        .defaultCutout()

    event.create('wet_web')
        .soundType('wood')
        .hardness(1)
        .resistance(1)
        .mapColor('#FF5500')
