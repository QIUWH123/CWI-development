...
global.materialTypes = [
    // alloy
    { id: 'andesite_alloy', type: 'alloy', formula: '?', mp: 1198, fluid: 'kubejs:molten_andesite_alloy', items: { dust: 'kubejs:andesite_alloy_powder', ingot: 'create:andesite_alloy', rod: 'vintageimprovements:andesite_rod', wire: 'vintageimprovements:andesite_wire', sheet: 'vintageimprovements:andesite_sheet', block: 'create:andesite_alloy_block' } },
    { id: 'brass', type: 'alloy', formula: 'CuZn', mp: 1153, fluid: 'kubejs:molten_brass', items: { dust: 'kubejs:brass_powder', ingot: 'create:brass_ingot', nugget: 'create:brass_nugget', sheet: 'create:brass_sheet', rod: 'createaddition:brass_rod', wire: 'vintageimprovements:brass_wire', block: 'create:brass_block' } },
    { id: 'bronze', type: 'alloy', formula: 'Cu₄Sn', mp: 1217, fluid: 'kubejs:molten_bronze', items: { dust: 'kubejs:bronze_powder', ingot: 'kubejs:bronze_ingot', nugget: 'kubejs:bronze_nugget', sheet: 'kubejs:bronze_sheet', rod: 'kubejs:bronze_rod', wire: 'kubejs:bronze_wire', block: 'kubejs:bronze_block' } },
    { id: 'constantan', type: 'alloy', formula: 'Cu₃Ni', mp: 1525, fluid: 'kubejs:molten_constantan', items: { dust: 'kubejs:constantan_powder', ingot: 'tfmg:constantan_ingot', nugget: 'tfmg:constantan_nugget', sheet: 'vintageimprovements:constantan_sheet', rod: 'vintageimprovements:constantan_rod', wire: 'tfmg:constantan_wire', block: 'tfmg:constantan_block' } },
    { id: 'electrum', type: 'alloy', formula: 'Au₃Ag', mp: 1213, fluid: 'kubejs:molten_electrum', items: { dust: 'kubejs:electrum_powder', ingot: 'createaddition:electrum_ingot', nugget: 'createaddition:electrum_nugget', sheet: 'createaddition:electrum_sheet', rod: 'createaddition:electrum_rod', wire: 'createaddition:electrum_wire', block: 'createaddition:electrum_block' } },

    // metal
    { id: 'aluminum', type: 'metal', formula: 'Al', mp: 933, fluid: 'kubejs:molten_aluminum', items: { dust: 'kubejs:aluminum_powder', ingot: 'tfmg:aluminum_ingot', nugget: 'tfmg:aluminum_nugget', sheet: 'tfmg:aluminum_sheet', rod: 'vintageimprovements:aluminum_rod', wire: 'tfmg:aluminum_wire', block: 'tfmg:aluminum_block' } },
    { id: 'cast_iron', type: 'metal', formula: 'Fe', mp: 1473, fluid: 'kubejs:molten_cast_iron', items: { dust: 'kubejs:cast_iron_powder', ingot: 'tfmg:cast_iron_ingot', nugget: 'tfmg:cast_iron_nugget', sheet: 'tfmg:cast_iron_sheet', rod: 'vintageimprovements:cast_iron_rod', wire: 'vintageimprovements:cast_iron_wire', block: 'tfmg:cast_iron_block' } },
    { id: 'cobalt', type: 'metal', formula: 'Co', mp: 1768, fluid: 'kubejs:molten_cobalt', items: { dust: 'kubejs:cobalt_powder', ingot: 'kubejs:cobalt_ingot', nugget: 'kubejs:cobalt_nugget', sheet: 'kubejs:cobalt_sheet', rod: 'kubejs:cobalt_rod', wire: 'kubejs:cobalt_wire', block: 'kubejs:cobalt_block' } },
    { id: 'copper', type: 'metal', formula: 'Cu', mp: 1358, fluid: 'kubejs:molten_copper', items: { dust: 'kubejs:copper_powder', ingot: 'minecraft:copper_ingot', nugget: 'create:copper_nugget', sheet: 'create:copper_sheet', rod: 'createaddition:copper_rod', wire: 'createaddition:copper_wire', block: 'minecraft:copper_block' } },
    { id: 'gold', type: 'metal', formula: 'Au', mp: 1337, fluid: 'kubejs:molten_gold', items: { dust: 'kubejs:gold_powder', ingot: 'minecraft:gold_ingot', nugget: 'minecraft:gold_nugget', sheet: 'create:golden_sheet', rod: 'createaddition:gold_rod', wire: 'createaddition:gold_wire', block: 'minecraft:gold_block' } },
    { id: 'industrial_iron', type: 'metal', formula: 'Fe', mp: 1503, fluid: 'kubejs:molten_industrial_iron', items: { dust: 'kubejs:industrial_iron_powder', ingot: 'createdeco:industrial_iron_ingot', nugget: 'createdeco:industrial_iron_nugget', sheet: 'createdeco:industrial_iron_sheet', block: 'create:industrial_iron_block' } },
    { id: 'iron', type: 'metal', formula: 'Fe', mp: 1443, fluid: 'kubejs:molten_iron', items: { dust: 'kubejs:iron_powder', ingot: 'minecraft:iron_ingot', nugget: 'minecraft:iron_nugget', sheet: 'create:iron_sheet', rod: 'createaddition:iron_rod', wire: 'createaddition:iron_wire', block: 'minecraft:iron_block' } },
    { id: 'lead', type: 'metal', formula: 'Pb', mp: 601, fluid: 'kubejs:molten_lead', items: { dust: 'kubejs:lead_powder', ingot: 'tfmg:lead_ingot', nugget: 'tfmg:lead_nugget', sheet: 'tfmg:lead_sheet', rod: 'vintageimprovements:lead_rod', wire: 'vintageimprovements:lead_wire', block: 'tfmg:lead_block' } },
    { id: 'magnesium', type: 'metal', formula: 'Mg', mp: 923, fluid: 'kubejs:molten_magnesium', items: { dust: 'kubejs:magnesium_powder', ingot: 'kubejs:magnesium_ingot', nugget: 'kubejs:magnesium_nugget', sheet: 'kubejs:magnesium_sheet', rod: 'kubejs:magnesium_rod', wire: 'kubejs:magnesium_wire', block: 'kubejs:magnesium_block' } },
    { id: 'molybdenum', type: 'metal', formula: 'Mo', mp: 2896, fluid: 'kubejs:molten_molybdenum', items: { dust: 'kubejs:molybdenum_powder', ingot: 'kubejs:molybdenum_ingot', nugget: 'kubejs:molybdenum_nugget', sheet: 'kubejs:molybdenum_sheet', rod: 'kubejs:molybdenum_rod', wire: 'kubejs:molybdenum_wire', block: 'kubejs:molybdenum_block' } },
    { id: 'nickel', type: 'metal', formula: 'Ni', mp: 1728, fluid: 'kubejs:molten_nickel', items: { dust: 'kubejs:nickel_powder', ingot: 'tfmg:nickel_ingot', nugget: 'tfmg:nickel_nugget', sheet: 'tfmg:nickel_sheet', rod: 'vintageimprovements:nickel_rod', wire: 'vintageimprovements:nickel_wire', block: 'tfmg:nickel_block' } },
    { id: 'silver', type: 'metal', formula: 'Ag', mp: 1235, fluid: 'kubejs:molten_silver', items: { dust: 'kubejs:silver_powder', ingot: 'kubejs:silver_ingot', nugget: 'kubejs:silver_nugget', sheet: 'kubejs:silver_sheet', rod: 'kubejs:silver_rod', wire: 'kubejs:silver_wire', block: 'kubejs:silver_block' } },
    { id: 'steel', type: 'metal', formula: 'Fe', mp: 1807, fluid: 'tfmg:molten_steel', items: { dust: 'kubejs:steel_powder', ingot: 'tfmg:steel_ingot', nugget: 'tfmg:steel_nugget', sheet: 'tfmg:heavy_plate', rod: 'vintageimprovements:steel_rod', wire: 'vintageimprovements:steel_wire', block: 'tfmg:steel_block' } },
    { id: 'tin', type: 'metal', formula: 'Sn', mp: 505, fluid: 'kubejs:molten_tin', items: { dust: 'kubejs:tin_powder', ingot: 'kubejs:tin_ingot', nugget: 'kubejs:tin_nugget', sheet: 'kubejs:tin_sheet', rod: 'kubejs:tin_rod', wire: 'kubejs:tin_wire', block: 'kubejs:tin_block' } },
    { id: 'vanadium', type: 'metal', formula: 'V', mp: 2183, fluid: 'kubejs:molten_vanadium', items: { dust: 'kubejs:vanadium_powder', ingot: 'vintageimprovements:vanadium_ingot', nugget: 'vintageimprovements:vanadium_nugget', sheet: 'vintageimprovements:vanadium_sheet', rod: 'vintageimprovements:vanadium_rod', wire: 'vintageimprovements:vanadium_wire', block: 'vintageimprovements:vanadium_block' } },
    { id: 'zinc', type: 'metal', formula: 'Zn', mp: 693, fluid: 'kubejs:molten_zinc', items: { dust: 'kubejs:zinc_powder', ingot: 'create:zinc_ingot', nugget: 'create:zinc_nugget', sheet: 'createaddition:zinc_sheet', rod: 'vintageimprovements:zinc_rod', wire: 'vintageimprovements:zinc_wire', block: 'create:zinc_block' } },

    // non-metal
    { id: 'diamond', type: 'non-metal', formula: 'C', mp: 3820, fluid: null, items: { dust: 'kubejs:diamond_powder', ingot: 'minecraft:diamond', block: 'minecraft:diamond_block' } },
