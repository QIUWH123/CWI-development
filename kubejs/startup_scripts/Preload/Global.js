...
global.materialTypes = [
    ...
    { id: 'industrial_iron', type: 'metal', formula: 'Fe', mp: 1503, stiffness: 210, fluid: 'kubejs:molten_industrial_iron', items: { powder: 'kubejs:industrial_iron_powder', ingot: 'createdeco:industrial_iron_ingot', nugget: 'createdeco:industrial_iron_nugget', sheet: 'createdeco:industrial_iron_sheet', block: 'create:industrial_iron_block' } },
    { id: 'rusted_iron', type: 'metal', formula: 'Fe', mp: 1257, stiffness: 200, fluid: null, items: { powder: 'kubejs:rusted_iron_powder', ingot: 'kubejs:rusted_iron_ingot', nugget: 'kubejs:rusted_iron_nugget', sheet: 'kubejs:rusted_iron_sheet', rod: 'kubejs:rusted_iron_rod', wire: 'kubejs:rusted_iron_wire', block: 'kubejs:rusted_iron_block' } },
    { id: 'iron', type: 'metal', formula: 'Fe', mp: 1443, stiffness: 210, fluid: 'kubejs:molten_iron', items: { powder: 'kubejs:iron_powder', ingot: 'minecraft:iron_ingot', nugget: 'minecraft:iron_nugget', sheet: 'create:iron_sheet', rod: 'createaddition:iron_rod', wire: 'createaddition:iron_wire', block: 'minecraft:iron_block' } },
    ...
    { id: 'nickel', type: 'metal', formula: 'Ni', mp: 1728, stiffness: 200, fluid: 'kubejs:molten_nickel', items: { powder: 'kubejs:nickel_powder', ingot: 'tfmg:nickel_ingot', nugget: 'tfmg:nickel_nugget', sheet: 'tfmg:nickel_sheet', rod: 'vintageimprovements:nickel_rod', wire: 'vintageimprovements:nickel_wire', block: 'tfmg:nickel_block' } },
    ...
    { id: 'steel', type: 'metal', formula: 'Fe', mp: 1807, stiffness: 210, fluid: 'tfmg:molten_steel', items: { powder: 'kubejs:steel_powder', ingot: 'tfmg:steel_ingot', nugget: 'tfmg:steel_nugget', sheet: 'tfmg:heavy_plate', rod: 'vintageimprovements:steel_rod', wire: 'vintageimprovements:steel_wire', block: 'tfmg:steel_block' } },
