...
global.materialTypes = [
    // alloys
    { id: 'andesite_alloy', type: 'alloy', formula: '?', mp: 1198, stiffness: 156, fluid: 'kubejs:molten_andesite_alloy', items: { powder: 'kubejs:andesite_alloy_powder', ingot: 'create:andesite_alloy', rod: 'kubejs:andesite_alloy_rod', wire: 'kubejs:andesite_alloy_wire', sheet: 'kubejs:andesite_alloy_sheet', spring: 'kubejs:andesite_alloy_spring', block: 'create:andesite_alloy_block' } },
    ...
    { id: 'steel', type: 'metal', formula: 'Fe', mp: 1807, stiffness: 223, fluid: 'tfmg:molten_steel', items: { powder: 'kubejs:steel_powder', ingot: 'tfmg:steel_ingot', nugget: 'tfmg:steel_nugget', sheet: 'tfmg:heavy_plate', rod: 'kubejs:steel_rod', wire: 'kubejs:steel_wire', spring: 'kubejs:steel_spring', block: 'tfmg:steel_block' } },
